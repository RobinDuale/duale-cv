...
## Sujets à éviter en doublon

- Migration vers le modèle abonnement / ARR (traité en profondeur)
- Productivité IA / adoption IA en entreprise (deux articles)
- Avantage humain face à l'IA / soft skills (traité)
- Personal branding et transition de carrière dirigeant (traité)
- Due diligence et signaux d'exit PE — ARR, NRR, dashboards (traité en profondeur)

---

## Thèmes non encore couverts (pistes)

- Data comme actif stratégique en contexte PE
- Croissance externe : intégrer une acquisition sans perdre la culture
- Structurer une organisation commerciale B2B pour l'exit
- Gouvernance et reporting en contexte fonds PE
- Pricing et valeur perçue en SaaS B2B
- Leadership en période de restructuration
- Recrutement et rétention des talents clés en PME PE-backed
- Roadmap produit : arbitrer entre dette technique et croissance
