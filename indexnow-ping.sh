...
PAYLOAD="{
    ...
    \"urlList\": [
      ...
      \"https://${HOST}/en/perspectives/switching-to-100-percent-subscription.html\",
      \"https://${HOST}/en/perspectives/successful-exit-what-buyers-really-look-at.html\",
      \"https://${HOST}/en/perspectives/acquisition-what-buyers-almost-always-underestimate.html\",
